...
class ModelNew(nn.Module):
    ...
    def forward(self, input: torch.Tensor, osizeT: int, osizeH: int, osizeW: int) -> torch.Tensor:
        return bang_func_ext.bang_func(input, osizeT, osizeH, osizeW)
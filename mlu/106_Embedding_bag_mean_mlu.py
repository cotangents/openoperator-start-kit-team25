...
class ModelNew(nn.Module):
    ...
    def forward(self, indices: torch.Tensor, offsets: torch.Tensor) -> torch.Tensor:
        return bang_func_ext.bang_func(indices, offsets, self.num_embeddings, self.embedding_dim)